...
Transform::Transform() : Node("transform_node"),
    ...
    parents_frame = this->declare_parameter<std::string>("parents_frame", "odom");
    child_frame = this->declare_parameter<std::string>("child_frame", "laser");
    x = this->declare_parameter<double>("x", 0.0);
    y = this->declare_parameter<double>("y", 0.0);
    z = this->declare_parameter<double>("z", 0.0);
